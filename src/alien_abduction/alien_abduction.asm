...
man_x_coordinate:  db 0
man_y_coordinate:  db 180
floor_attr_x:      db 0
floor_attr_y:      db 23
sky_attr_x:        db 0
sky_attr_y:        db 0
...
;Frames:           7
;sprite_man_frame_0:
;        DEFB 12,0,12,0,63,0,12,0, 12,  0, 12,  0, 18,  0, 51,  0
...
sprite_man_frame_1:
        DEFB 6,  0,  6,  0, 31,128,  6,  0, 6,  0,  6,  0,  9,  0, 25,128
